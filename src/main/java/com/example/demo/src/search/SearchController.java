...
public class SearchController {
    ...
    @Autowired
    private final com.example.demo.src.chat.ChatProvider chatProvider;
    @Autowired
    private final com.example.demo.src.chat.ChatService chatService;
    @Autowired
    private final JwtService jwtService;


    public SearchController(ChatProvider chatProvider, ChatService chatService, JwtService jwtService) {
